...
from pipeline.core.config import Paths, record_manifest
from pipeline.utils import manifest_items
...
def build_prompt_views(paths: Paths, manifest: Dict) -> None:
    ...
    for item in items:
        ...
        normalized_paths[item_id] = str(out_dir / "canonical.txt")

    manifest_path = paths.manifest_path
    manifest["normalized"] = normalized_paths
